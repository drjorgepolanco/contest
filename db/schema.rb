...
ActiveRecord::Schema.define(version: 20140209093202) do
  ...
  add_index "votes", ["user_id", "post_id", "contest_id"], name: "index_votes_on_user_id_and_post_id_and_contest_id", using: :btree
