...
describe User do
  ...
  describe "when password is not present" do
    before do
      @user = User.new(first_name: "Jorge", last_name: "Polanco", email: "drjorgepolanco@gmail.com",
  ...
  describe "post associations" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.posts.create!(title: "Lorem Ipsum",
                                              description: "Color sit amet makagrano",
                                              image: "https://scontent-b-dfw.xx.fbcdn.net/hphotos-prn1/v/1527837_10153668490105627_1046532736_n.jpg")}
      end
