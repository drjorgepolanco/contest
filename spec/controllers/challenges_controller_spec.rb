...
#         post :create, {:challenge => { "user" => "invalid value" }}, valid_session
#         assigns(:challenge).should be_a_new(Challenge)
#       end
...
#         Challenge.any_instance.should_receive(:update).with({ "user" => "" })
#         put :update, {:id => challenge.to_param, :challenge => { "user" => "" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Challenge.any_instance.stub(:save).and_return(false)
#         put :update, {:id => challenge.to_param, :challenge => { "user" => "invalid value" }}, valid_session
#         assigns(:challenge).should eq(challenge)
#       end
